...
//Network.cpp
//Project 5 - Made function to sort the feed using helper functions from the LinkedList
****************************************************************************************************************************/
...
//create copy of feed
LinkedList<Post*> copy = feed_; //make a copy of the feed to sort
copy.bubbleSort(compare, counter); //sorts the copy using the linkedlist functiojn
