...
class LinkedList {
    ...
    public:
        ...
        */
        ...
        //helper
        //swap - takes in two nodes - swap the values inside the nodes use getItem() and setItem()
         //bubbleSort
        template<typename Comparator>
        void bubbleSort(Comparator compare, int* count); //helper function to sort the feed from the network
        void swapNodes( Node<ItemType> &item, Node<ItemType> &item2); //helper function to swap the value of the nodes in bubbleSort function
